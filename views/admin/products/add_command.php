    ...
    <div class="uk-flex uk-flex-middle uk-margin" uk-grid>
      <div class="uk-width-expand">
        <ul class="uk-breadcrumb uk-margin-remove">
          ...
          <li><a href="<?= site_url('store/admin/products/'. $product->id) ?>"><?= lang('commands') ?></a></li>
        </ul>
          ...
          <div class="uk-margin-small">
            ...
            <div class="uk-radio-button-group bc-show-group">
              <div class="uk-radio-container">
                <input class="uk-radio-button" type="radio" name="type" value="item" <?= set_radio('type', 'item') ?>>
              ...
              <div class="uk-radio-container">
                <input class="uk-radio-button" type="radio" name="type" value="custom" <?= set_radio('type', 'custom') ?>>
                <div class="uk-label-container">
                  <div class="uk-label-dot"></div>
