        ...
        <div class="uk-card-body">
              ...
              <div class="uk-grid-small" uk-grid>
                <div class="uk-width-1-2@s">
                  ...
                  <div class="uk-form-controls">
                    <input class="uk-input" type="text" name="item" value="<?= $command->item ?>" placeholder="<?= lang('item') ?>" autocomplete="off">
                  </div>
                ...
                <div class="uk-width-1-2@s">
                  ...
                  <div class="uk-form-controls">
                    <input class="uk-input" type="text" name="quantity" value="<?= $command->quantity ?>" placeholder="<?= lang('quantity') ?>" autocomplete="off">
                  </div>
          ...
          <div id="type_custom" hidden>
            <div class="uk-margin-small">
              ...
              <div class="uk-form-controls">
                <textarea class="uk-textarea" name="command" rows="2" autocomplete="off"><?= $command->command ?></textarea>
              </div>
