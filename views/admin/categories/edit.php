  ...
  <div class="uk-container">
    <div class="uk-flex uk-flex-middle uk-margin" uk-grid>
      <div class="uk-width-expand">
        ...
        <h1 class="uk-h3 uk-text-bold uk-margin-remove"><?= lang('edit_category') ?></h1>
      </div>
          ...
          <div class="uk-grid-small uk-margin-small" uk-grid>
            <div class="uk-width-1-2@s">
              ...
              <div class="uk-form-controls">
                <input class="uk-input" type="text" name="name" value="<?= $category->name ?>" placeholder="<?= lang('name') ?>" autocomplete="off">
              </div>
            ...
            <div class="uk-width-1-2@s">
              ...
              <div class="uk-form-controls">
                <input class="uk-input" type="text" name="slug" value="<?= $category->slug ?>" placeholder="<?= lang('slug') ?>" autocomplete="off">
              </div>
            ...
            <div class="uk-width-1-2@s">
              ...
              <div class="uk-form-controls">
                <select class="uk-select tail-single" id="select_type" name="type" autocomplete="off" data-placeholder="<?= lang('select_type') ?>">
                  <option value="<?= ITEM_LINK ?>" <?= set_select('type', ITEM_LINK, ITEM_LINK === $category->type) ?>><?= lang('link') ?></option>
                  <option value="<?= ITEM_DROPDOWN ?>" <?= set_select('type', ITEM_DROPDOWN, ITEM_DROPDOWN === $category->type) ?>><?= lang('dropdown') ?></option>
                </select>
              </div>
            ...
            <div class="uk-width-1-2@s">
              ...
              <div class="uk-form-controls">
                <select class="uk-select tail-single" id="select_parent" name="parent" autocomplete="off" data-placeholder="<?= lang('select_parent') ?>">
                  <option value="0" <?= set_select('parent', '0', '0' === $category->parent) ?>><?= lang('no_parent') ?></option>
                  <?php foreach ($parents as $item): ?>
                  <option value="<?= $item->id ?>" <?= set_select('parent', $item->id, $item->id === $category->parent) ?>><?= $item->name ?></option>
                  <?php endforeach ?>
                </select>
              </div>
